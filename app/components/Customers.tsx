...
import c_1 from "@/public/assets/images/customer/c-1.png";
import c_2 from "@/public/assets/images/customer/c-2.png";
import c_3 from "@/public/assets/images/customer/c-3.png";

const Customers = () => {
  return (
    <section className="py-20 shadow container px-16">
      <div className="flex justify-center items-center gap-1 py-3">
        <LuCircleDot className="text-[#d8d46f] text-sm" />
        <LuCircleDot className="text-[#d8d46f] text-sm" />
        <LuCircleDot className="text-[#d8d46f] text-sm" />
      </div>
        ...
        <div className="mx-2 bg-white border-gray-200 rounded-lg shadow relative flex flex-col justify-center items-center">
          <div className="p-10 flex flex-col justify-center items-start">
            ...
            <p className="mb-3 font-normal text-gray-700 border-b-2 border-gray-300 text-xs py-5 md:text-lg">
              Here are the biggest enterprise technology acquisitions of 2021 order.
            </p>
            <div className="flex justify-center items-center">
              ...
              <div className="ml-2">
                <p className="text-lg text-black font-semibold">Mathew Taylor</p>
